...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quizz.level'
        db.add_column('QCM_quizz', 'level',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['QCM.Level']),
                      keep_default=False)

        # Adding field 'Quizz.subject'
        db.add_column('QCM_quizz', 'subject',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['QCM.Subject']),
                      keep_default=False)

        # Adding field 'Quizz.chapter'
        db.add_column('QCM_quizz', 'chapter',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['QCM.Chapter']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Quizz.level'
        db.delete_column('QCM_quizz', 'level_id')

        # Deleting field 'Quizz.subject'
        db.delete_column('QCM_quizz', 'subject_id')

        # Deleting field 'Quizz.chapter'
        db.delete_column('QCM_quizz', 'chapter_id')
    ...
    models = {
        ...
        'QCM.quizz': {
            ...
            'chapter': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['QCM.Chapter']"}),
            'date_started': ('django.db.models.fields.DateTimeField', [], {}),
            'grade': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'level': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['QCM.Level']"}),
            'questions': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['QCM.Question']", 'symmetrical': 'False'}),
            'subject': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['QCM.Subject']"}),
