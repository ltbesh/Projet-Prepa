...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('QCM_news', 'title')

        # Adding field 'News.number'
        db.add_column('QCM_news', 'number',
    ...
    def backwards(self, orm):
        ...
        db.add_column('QCM_news', 'title',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=200),
                      keep_default=False)

        # Deleting field 'News.number'
        db.delete_column('QCM_news', 'number')
