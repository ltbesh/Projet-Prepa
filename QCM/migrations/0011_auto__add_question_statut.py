...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'QCM.question_statut': {
            'Meta': {'object_name': 'Question_statut'},
        ...
        'QCM.quizz': {
            ...
            'questions': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['QCM.Question']", 'through': "orm['QCM.Question_statut']", 'symmetrical': 'False'}),
