...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quizz.completion'
        db.add_column('QCM_quizz', 'completion',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Quizz.completion'
        db.delete_column('QCM_quizz', 'completion')
    ...
    models = {
        ...
        'QCM.quizz': {
            ...
            'grade': ('django.db.models.fields.IntegerField', [], {'default': "'unfinished'"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
