...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Quizz.chapter'
        db.alter_column('QCM_quizz', 'chapter_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['QCM.Chapter'], null=True))

        # Changing field 'Quizz.level'
        db.alter_column('QCM_quizz', 'level_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['QCM.Level'], null=True))

        # Changing field 'Quizz.subject'
        db.alter_column('QCM_quizz', 'subject_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['QCM.Subject'], null=True))

    def backwards(self, orm):

        # Changing field 'Quizz.chapter'
        db.alter_column('QCM_quizz', 'chapter_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['QCM.Chapter']))

        # Changing field 'Quizz.level'
        db.alter_column('QCM_quizz', 'level_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['QCM.Level']))

        # Changing field 'Quizz.subject'
        db.alter_column('QCM_quizz', 'subject_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['QCM.Subject']))
